...
const CardComponent = (props) => {
    ...
    let card = <div className="card border-dark my-3">
                <img src={imageLinks === undefined ? "https://via.placeholder.com/300?text=Not+Found" : imageLinks.thumbnail.replace("http", "https")} className="card-img-top" alt={title} height="300" />
